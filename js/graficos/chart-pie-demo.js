...
document.addEventListener("DOMContentLoaded", function () {
      ...
      .then((data) => {
        if (data.length === 0) {
          ...
          colorBox.style.backgroundColor =
            myPieChart.data.datasets[0].backgroundColor[i];
  ...
  function actualizarDropdown(mesSeleccionado) {
    ...
    document.getElementById("mesSeleccionado").textContent =
  ...
  document.querySelectorAll("#listaGrafico").forEach((item) => {
